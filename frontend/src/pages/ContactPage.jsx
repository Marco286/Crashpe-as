        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#171717] border border-neutral-800 rounded-sm overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=Rua+Marquês+de+Pombal,+Olhos+de+Água,+Palmela,+Portugal&zoom=16"
                width="100%"
                height="350"
                style={{ border: 0 }}
                allowFullScreen=""
