        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 border border-neutral-700 hover:border-red-600 text-neutral-300 hover:text-white px-4 py-2 transition-all duration-200 text-sm font-bold rounded-sm"
            >
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <a href="tel:+351212131390"
                className="flex items-center gap-2 text-neutral-400 text-base font-bold py-2">
                <Phone className="w-4 h-4 text-red-600" />
                21 213 1390
              </a>
              <Link to="/solicitar" onClick={() => setIsOpen(false)}>
                <Button
                  className="w-full mt-2 bg-red-600 hover:bg-red-700 text-white font-bold uppercase tracking-wider py-4 rounded-sm"
